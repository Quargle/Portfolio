    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-jwbfy2");
    			add_location(img, file$3, 18, 4, 377);
    			attr_dev(h3, "class", "svelte-jwbfy2");
    			add_location(h3, file$3, 19, 4, 435);
    			attr_dev(a, "id", /*id*/ ctx[0]);
    			attr_dev(a, "class", "project-tile svelte-jwbfy2");
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "href", /*link*/ ctx[1]);
    			add_location(a, file$3, 12, 0, 287);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
